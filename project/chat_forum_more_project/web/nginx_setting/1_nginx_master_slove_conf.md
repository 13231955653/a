...
docker cp /usr/local/white/buckup/www/myself/project/chat_forum_more_project/web/nginx_setting/3_nginx_slove_son.conf static_resource_slove_1:/etc/nginx/conf.d
...
docker cp /usr/local/white/buckup/www/myself/project/chat_forum_more_project/web/nginx_setting/4_nginx_slove_son.conf static_resource_slove_2:/etc/nginx/conf.d
