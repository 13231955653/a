...
//    直接从数据库查找
    ...
    function searchByFirstWordVoice (
        ...
        $aWhere                                   = [];
        $aWhere[ ChengYuModel::pinyinFinalMd5() ] = ChengYuModel::urlencodeMd5(
            ChengYuModel::urlencode( $sSearchWord )
        );
    ...
    function searchByFinalWordVoice (
        ...
        $aWhere                                   = [];
        $aWhere[ ChengYuModel::pinyinFisrtMd5() ] = ChengYuModel::urlencodeMd5(
            ChengYuModel::urlencode( $sSearchWord )
        );
        return self::searchNextWord(
            $sSearchWord,
    ...
    function searchByFinalVoiceMother (
        ...
        $aWhere                                           = [];
        $aWhere[ ChengYuModel::finallyWordPinYinFinal() ] = $sSearchWord;
        return self::searchNextWord(
            $sSearchWord,
            $aWhere,
            $bGetDerivation,
    ...
    function searchByFinalPinYin (
        ...
        $aWhere                                      = [];
        $aWhere[ ChengYuModel::finallyWordPinYin() ] = $sSearchWord;
        return self::searchNextWord(
            $sSearchWord,
            $aWhere,
            $bGetDerivation,
    ...
    function searchByFinalWord (
        ...
        $aWhere                                   = [];
        $aWhere[ ChengYuModel::finallyWordMd5() ] = ChengYuModel::urlencodeMd5(
            trim( $sSearchWord )
        );
        return self::searchNextWord(
            $sSearchWord,
    ...
    function searchByPinYin (
        ...
        $aWhere                                    = [];
        $aWhere[ ChengYuModel::firstWordPinYin() ] = trim( $sSearchWord );
        return self::searchNextWord(
            $sSearchWord,
            $aWhere,
            $bGetDerivation,
    ...
    function searchByVoiceMother (
        ...
        $aWhere                                         = [];
        $aWhere[ ChengYuModel::firstWordPinYinFirst() ] = trim(
            $sSearchWord
        );
        return self::searchNextWord(
            $sSearchWord,
    ...
    function searchByFirstWord (
        ...
        $aWhere                                 = [];
        $aWhere[ ChengYuModel::firstWordMd5() ] = ChengYuModel::urlencodeMd5(
            $sSearchWord
        );
        return self::searchNextWord(
            $sSearchWord,
    ...
    function searchNextWord (
        ...
        $sPrikey       = ChengYuModel::primary();
        $sStatusKey    = ChengYuModel::status();
        ...
        $aGetData   = [];
        $aGetData[] = ChengYuModel::word();
        $aGetData[] = $sPrikey;
        if ( $bGetDerivation ) {
            //            var_dump('获取起源');
            array_push( $aGetData, ChengYuModel::derivation() );
        }
        if ( $bGetExample ) {
            //            var_dump('获取例子');
            array_push( $aGetData, ChengYuModel::example() );
        }
        if ( $bGetExplain ) {
            //            var_dump('获取额外说明');
            array_push( $aGetData, ChengYuModel::explanation() );
        }
        if ( $bGetPinYin ) {
            //            var_dump('获取拼音');
            array_push( $aGetData, ChengYuModel::pinyin() );
        }
    ...
    private static function insertNeedInsertByLabour ($sSearchWord = '', $iSearchType)
    {
        ...
        $sReplenishWordFeild = ReplenishChengYuModel::word();
        $sReplenishWordMd5Feild = ReplenishChengYuModel::wordMd5();
        $sReplenishAddTimeFeild = ReplenishChengYuModel::addTime();
        $sReplenishTypeFeild = ReplenishChengYuModel::type();
        $sReplenishUrlEncodeFeild = ReplenishChengYuModel::urlencodeFeild();
        ...
        $aData[$sReplenishUrlEncodeFeild] = ReplenishChengYuModel::urlEncode($sSearchWord);
    ...
    private static function updateUsedNumber ($iId = 0)
    {
        ...
        $aWhere[ ChengYuModel::primary() ] = (int)$iId;

        $aData = [];
        $aData[MysqlTool::incrbyKey()][ChengYuModel::usedNumber()] = 1;
        $aData[ChengYuModel::lastUsedTime()] = Time::nowRunTime();
