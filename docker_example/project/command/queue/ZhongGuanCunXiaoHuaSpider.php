...
use model\publics\ZhongGuanCunXiaoHuaSpider as ZhongGuanCunXiaoHuaSpiderModel;
...
class ZhongGuanCunXiaoHuaSpider extends CommandFather
{
    public $sCommandName = 'queue_zhong_guan_cun_xiao_hua_spider';
    ...
    function popList ()
    {
        $this->sQueueName = Queue::setQueueName(Queue::spiderCurlQueueName());
    ...
    function update (
        ...
        $sTable = ZhongGuanCunXiaoHuaSpiderModel::table();

        $sPrimaryKey = ZhongGuanCunXiaoHuaSpiderModel::primary();
        $aDataKeys   = [];
        ...
        foreach ( $res as $k => $v ) {
            ...
            if ( in_array( $k, [ ZhongGuanCunXiaoHuaSpiderModel::curlNumber() ] ) ) {
